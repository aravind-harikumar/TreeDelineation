...
% Contrast: matlab/[1,2]                    (out.contr) [1]
% Correlation: matlab                       (out.corrm)
% Correlation: [1,2]                        (out.corrp) [1]
% Cluster Prominence: [2]                   (out.cprom)
% Cluster Shade: [2]                        (out.cshad)
% Dissimilarity: [2]                        (out.dissi)
% Energy: matlab/angular second mom / [1,2] (out.energ) [1]
% Entropy: [2]                              (out.entro) [1]
% Homogeneity: matlab                       (out.homom)
% Homogeneity: [2]                          (out.homop)
% Maximum probability: [2]                  (out.maxpr)
% Sum of sqaures: Variance [1]              (out.sosvh) [1]
% Sum average [1]                           (out.savgh) [1]
% Sum variance [1]                          (out.svarh) [1]
% Sum entropy [1]                           (out.senth) [1]
% Difference variance [1]                   (out.dvarh) [1]
% Difference entropy [1]                    (out.denth) [1]
% Information measure of correlation1 [1]   (out.inf1h) [1]
% Informaiton measure of correlation2 [1]   (out.inf2h) [1]
% Inverse difference (INV) is homom [3]     (out.homom)
% Inverse difference normalized (INN) [3]   (out.indnc) 
% Inverse difference moment normalized [3]  (out.idmnc) [1]
%
...
out.contr = zeros(1,size_glcm_3); % Contrast: matlab/[1,2] %--% Haralick
