...
% hms = GLCM_Features1(coMat,0);
% harMat =  [ hms.autoc   hms.corrm  hms.corrp hms.cprom  hms.cshad hms.dissi hms.energ  hms.entro  hms.homom hms.homop...
%      hms.maxpr hms.sosvh  hms.savgh  hms.svarh  hms.senth  hms.dvarh  hms.denth  hms.inf1h  hms.inf2h  hms.indnc  hms.idmnc ];
% 
% %harMat = [  hms.entro  hms.corrp  hms.contr  hms.homop hms.sosvh...
% %hms.savgh   hms.cshad hms.cprom hms.maxpr hms.autoc hms.idmnc];
%  %%hms.autoc   hms.corrm  hms.cprom ...
% %    hms.cshad hms.dissi   hms.homom...
% %     hms.maxpr hms.sosvh  hms.savgh  hms.svarh  hms.senth  hms.dvarh  hms.denth  hms.inf1h  hms.inf2h  hms.indnc  hms.idmnc ];
